...
#' This function calls the plotGeneCount function and plots  FPKMs for the genes defined in the 
#' MARKER_GENES table.
#' @param result_table Passed directly to the plotGeneCount function; this can either be:
