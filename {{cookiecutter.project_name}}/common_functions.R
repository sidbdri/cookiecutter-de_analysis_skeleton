...
#'                or a result table. If left empty, will read ./results/differential_expression/de_gene/deseq2_results_fpkm.csv by default.
...
#' @param filter_string A string. This will be applied when selecting the samples from the result table. Example: filter="condition=='5xFAD'".
...
plotGeneCount <- function(gene_identifier,result_table=NULL,debug=FALSE,print=FALSE,
  ...
  if(is.null(result_table)) result_table<-'./results/differential_expression/de_gene/deseq2_results_fpkm_human.csv'
